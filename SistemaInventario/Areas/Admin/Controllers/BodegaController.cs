...
namespace SistemaInventario.Areas.Admin.Controllers
{
    ...
    public class BodegaController : Controller
    {
        ...
        //Metodo de tipo Get, llama a la vista
        ...
        //Para crear y actualizar una nueva bodega ya existente necesitamos el metodo Post
        [HttpPost]
        ...
        public async Task<IActionResult> ValidarNombre(String nombre, int id = 0)
        {
            ...
            if (id == 0)
            {
                valor = lista.Any(b => b.Nombre.ToLower() == nombre.ToLower().Trim());
            }
            else
            {
                valor = lista.Any(b => b.Nombre.ToLower() == nombre.ToLower().Trim() && b.Id !=id);
            }
            if (valor)
            {
